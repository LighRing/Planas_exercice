...
namespace PeopleViewer
{
    public partial class App : Application
    {
        ...
        private void ComposeObject()
        {
            ...
            //IRepository repo_caching = new CachingReader(repository);

            // TODO 3-2 : Créer le view model (PeopleViewModel)
            //PeopleViewModel pvm = new PeopleViewModel(repo_caching);
            //Application.Current.MainWindow = new MainWindow(pvm);
